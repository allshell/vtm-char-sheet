...
1. [#VtM-骰子插件-v_1.8.7](https://github.com/allshell/vtm-char-sheet?tab=readme-ov-file#vtm-%E9%AA%B0%E5%AD%90%E6%8F%92%E4%BB%B6-v_186)
...
本插件为 **SealDice (海豹骰)** 核心配套插件。下载项目中的插件文件 `vtm_1.8.7.js`，使用海豹骰核心加载 JS 插件并启动后，即可按需激活使用。
...
* 点击 **“复制指令”**，将其发送至安装了 `vtm_1.8.7.js` 插件的 SealDice 窗口即可完成录卡 。
