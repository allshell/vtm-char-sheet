...
1. [VtM 骰子插件（适配海豹骰核心）](https://github.com/allshell/vtm-char-sheet/edit/main/README.md#vtm-%E9%AA%B0%E5%AD%90%E6%8F%92%E4%BB%B6-v_184)；
2. [与插件配套的录卡工具](https://github.com/allshell/vtm-char-sheet/edit/main/README.md#vtm-%E8%A7%92%E8%89%B2%E5%8D%A1%E5%BD%95%E5%85%A5%E8%BE%85%E5%8A%A9%E5%B7%A5%E5%85%B7-v_002)。

# VtM 骰子插件 v_1.8.4

本插件为 **SealDice (海豹骰)** 核心配套插件。下载项目中的插件文件 `vtm_1.8.4.js`，使用海豹骰核心加载 JS 插件并启动后，即可按需激活使用。
...
**录卡后检定**
- `.va属性+技能k难度` 成功录卡后，自动调用卡中的骰池和饥渴值进行检定，多个属性/技能之间以加号连接，也可直接使用数字作为骰池加值。
- 例：`.va敏捷+白刃k4`；`.va敏捷+4k4`
...
* 点击 **“复制指令”**，将其发送至安装了 `vtm_1.8.4.js` 插件的 SealDice 窗口即可完成录卡 。
